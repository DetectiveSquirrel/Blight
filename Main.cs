...
public class Main : BaseSettingsPlugin<BlightSettings>
{
    ...
    private readonly List<Entity> towerList = [];
    ...
    public List<Entity> BlightEntities = new();
    public List<Entity> drawList = new();
    ...
    {
        if (!Settings.Enable.Value || !GameController.InGame || IngameData == null || PlayerPos == Vector3.Zero)
        {
            return;
        }
